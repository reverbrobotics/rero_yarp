...
#ifndef _RERO_NLU_THREAD_H_
#define _RERO_NLU_THREAD_H_
...
class ReroNLUThread : public yarp::os::Thread {
...
private:
	 ...
	 * =========================================================================== */
    yarp::os::BufferedPort< yarp::os::Bottle >  inputNLUPort;

    yarp::os::BufferedPort< yarp::os::Bottle >  outNLUPort;

	/* ===========================================================================
	 *  Yarp Matrices used for Modules Computation. 
	 *    Objects passed around to encapsulated objects.
	 * =========================================================================== */
    yarp::os::Bottle* inputNLU;
    yarp::os::Bottle* outputNLU;
...
public:
	 ...
	 * =========================================================================== */
	ReroNLUThread(std::string configFile);
