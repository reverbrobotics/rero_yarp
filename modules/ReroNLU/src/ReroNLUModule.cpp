...
/* ===========================================================================
 * @file  ReroNLUModule.cpp
 * @brief Implementation of the ReroNLUModule (see header file).
 * =========================================================================== */

#include <ReroNLUModule.h>

bool ReroNLUModule::configure(yarp::os::ResourceFinder &rf) {
	 ...
	 * =========================================================================== */
	moduleName = rf.check("name", yarp::os::Value("/reroNLU"), "module name (string)").asString();
     ...
     * =========================================================================== */
    thread = new ReroNLUThread(configFile);
...
bool ReroNLUModule::interruptModule() {
	handlerPort.interrupt();
	return true;
}


bool ReroNLUModule::close() {
...
bool ReroNLUModule::respond(const yarp::os::Bottle& command, yarp::os::Bottle& reply) {
...
double ReroNLUModule::getPeriod() {
	/* Module periodicity (seconds), called implicitly by myModule. */
	return 1;
}


bool ReroNLUModule::updateModule() {
