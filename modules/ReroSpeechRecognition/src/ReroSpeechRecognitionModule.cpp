...
/* ===========================================================================
 * @file  ReroSpeechRecognitionModule.cpp
 * @brief Implementation of the ReroSpeechRecognitionModule (see header file).
 * =========================================================================== */

#include <ReroSpeechRecognitionModule.h>

bool ReroSpeechRecognitionModule::configure(yarp::os::ResourceFinder &rf) {
	 ...
	 * =========================================================================== */
	moduleName = rf.check("name", yarp::os::Value("/reroSpeechRecognition"), "module name (string)").asString();
...
bool ReroSpeechRecognitionModule::interruptModule() {
	handlerPort.interrupt();
	return true;
}


bool ReroSpeechRecognitionModule::close() {
...
bool ReroSpeechRecognitionModule::respond(const yarp::os::Bottle& command, yarp::os::Bottle& reply) {
...
double ReroSpeechRecognitionModule::getPeriod() {
	/* Module periodicity (seconds), called implicitly by myModule. */
	return 1;
}


bool ReroSpeechRecognitionModule::updateModule() {
