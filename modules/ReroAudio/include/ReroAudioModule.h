...
/* ===========================================================================
 * @file  ReroAudioModule.h
 * @brief This module relays a stream of raw audio from gRPC to YARP
 * =========================================================================== */

#ifndef _RERO_AUDIO_MODULE_H_
#define _RERO_AUDIO_MODULE_H_
...
class ReroAudioModule : public yarp::os::RFModule { 
  ...
  private:
	...
	ReroAudioPeriodicThread *periodicThread; 
